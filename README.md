...
Calculate or verify SHA-256 and SHA-512 digests for local files.
...
Open <http://127.0.0.1:8087> in a browser. For CLI-capable tools, run `python3 app.py --help` to see the positional form.
